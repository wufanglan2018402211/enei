...
{	
	...
	score=0;
		...
		// 定义 IMAGE 对象
	loadimage(&img_bk, "E:/Rings//封面.jpg");	// 读取图片到 img 对象中
...
if (c[1].x==-100 &&c[2].x==-100 &&c[3].x==-100 )
{
	...
	mciSendString("open  E:/Rings//xtxiaochu.mp3 alias cxmusic", NULL, 0, NULL);
...
void gaming()
{
		...
		mciSendString("open  E:/Rings//bkmusic.mp3 alias bkmusic", NULL, 0, NULL);//背景音乐
